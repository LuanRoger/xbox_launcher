...
abstract class NavigationSectionStateful extends StatefulWidget
    implements NavigationSectionBase {
  @override
  final String sectionName;

  const NavigationSectionStateful(this.sectionName, {Key? key})
      : super(key: key);
}

abstract class NavigationSectionStatefulState
    extends State<NavigationSectionStateful>
    implements NavigationSectionWidget {
  @override
